...
class MovieAdapter(movieList: List<MovieResponse>, context: Context): RecyclerView.Adapter<MovieAdapter.ViewHolder>() {

    private var mContext: Context = context
    private var mMovieList: List<MovieResponse> = movieList
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        fun initData(mMovie: MovieResponse) {
